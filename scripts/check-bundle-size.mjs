 ...
 * route's chunk, which reads 244 kB against a real first load of 108 kB.
 */
...
for (const url of refs) {
  ...
  // the "First Load JS" figure that NFR-PERF-04's 200 kB was written against. It is
...
console.log(
  `\nfirst load: ${totalKb.toFixed(1)} kB gzipped / ${LIMIT_KB} kB (NFR-PERF-04)` +
